...
WORD_VEC_100 = os.path.join(
    "/home/touch/data/nlp/word_segmentation/adversarial-multi-criteria-learning-for-CWS/vec100.txt")
...
DATA_FILE = ['data_msr', 'data_as', 'data_pku', 'data_ctb',
             'data_ckip', 'data_cityu', 'data_ncc', 'data_sxu', 'data_weibo']
MAX_LEN = 80
